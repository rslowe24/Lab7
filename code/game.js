...
function Smoke(pos) {
  ...
  // Make it go back and forth in a sine wave.
  this.wobble = Math.random() * Math.PI * 2/100;
}
Smoke.prototype.type = "smoke";
...
Smoke.prototype.act = function(step) {
  this.wobble += step * 15;
  var wobblePos = Math.sin(this.wobble) * 0.5;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};
